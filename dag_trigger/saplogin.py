...
class SAPLogin:
    ...
    def _perform_login(self, connection_name, username, password, lang = "EN"):
    ...
    def login_to_s4hana(self, username="U0000753", password="@H1MuR4_2025_s4", lang="EN"):
        """Login S/4HANA"""
        try:
            self._initialize_sap_gui()
            return self._perform_login("SAP S/4 HANA PROD", username, password, lang=lang)
