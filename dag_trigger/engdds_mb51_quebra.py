...
def engdds_mb51_quebra_main():
    logging.info("---- INICIANDO PROCESSO: ENGDDS_MB51_QUEBRA.PY ----")
    ...
    try:
        ...
        caminho_base = meta_arquivos['engdds_mb51_quebra.py']['path']
        nome_arquivo = meta_arquivos['engdds_mb51_quebra.py']['files']
        ...
        logging.error(f'Erro ao exportar dados do relatório MB51_quebra :: {str(e)}')
        sap.limpar_processos()
        sap.cleanup()
