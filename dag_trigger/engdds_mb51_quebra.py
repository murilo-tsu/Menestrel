...
def engdds_mb51_quebra_main():
    ...
    executar_com_retry(erros=erros, etapa="MB51_QUEBRA", funcao=extrair_mb51_quebra, tentativas=3, intervalo=60)
    ...
    if erros:
        raise RuntimeError(
            "Ocorreram erros em uma ou mais extrações de MB51_QUEBRA:\n"
            + "\n".join(erros)
        )

    logging.info("---- ENGDDS_MB51_QUEBRA.PY finalizado com sucesso ----")
