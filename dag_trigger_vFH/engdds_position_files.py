...
def position_files_main():
    # 0 = segunda, 2 = quarta
    if date.today().weekday() not in (0, 2):
        print("position_files_main ignorado: hoje não é segunda nem quarta.")
        return
    # ::::::::::::::::::::::::::::::::::::::::
    # :: MB52 - ESTOQUE
    # ::::::::::::::::::::::::::::::::::::::::
    ...
    try:
        ...
        pass
    t_code = "MB52"
    # folder_path = r"C:\scripts\01_soe\Position\_stage_position"
    folder_path = r"C:\Users\datainsights.svc\OneDrive - heringer.com.br\Planejamento - Bases"
    folder_path = r"C:\Temp\t1\position_files"
